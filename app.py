...
def init_database():
    ...
    if cursor.fetchone()[0] == 0:
        ...
        cities = ['Mumbai', 'Delhi', 'Bangalore', 'Chennai', 'Lucknow', 'Hyderabad', 'Shimla', 'Ahmedabad']
...
# PAGE 5: EARLY WARNING
    ...
    DATA_PATH = os.path.join(BASE_DIR, "data", "derived_table.csv")
    MODEL_PATH = os.path.join(BASE_DIR, "models", "health_risk_model.pkl")
